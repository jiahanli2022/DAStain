...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--train_txt_neg', type=str)
        # parser.add_argument('--use_low_quality_image', action='store_true',)
        # parser.add_argument('--useBlur', action='store_true',)
        # parser.add_argument('--use_fake_128', action='store_true',)
        # parser.add_argument('--kernel_size', type=int, default=3, help='momentum term of adam')
        parser.add_argument('--pseudo_label_dir', type=str)
        parser.add_argument('--lambda_pseudo', type=float)
        parser.add_argument('--pseudo_fix', action='store_true')
        parser.add_argument('--nouse_pseudo', action='store_true')
